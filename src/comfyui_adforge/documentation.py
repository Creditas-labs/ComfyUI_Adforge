...
COMMOM_IO_TOOLTIPS = {
    ...
    "negative_prompt": (
        "Optional. A text string that describes anything you want to discourage "
        "the model from generating."
    ),
    ...
    "output_gcs_uri_list": (
        "A list of GCS URIs of the generated videos " "(when output_format=gcs_uri)."
    ),
    "output_video_path_list": (
        "A list of local paths to the generated videos " "(when output_format=local_file)"
    ),
    "output_format": (
        "Some videos are too large to be returned directly. Choose whether to get "
        "a GCS URI or save locally, when you choose one the other output will be "
    ),
    "output_gcs_uri": (
        "GCS URI where the generated videos will be stored, in the format "
...
TOOLTIPS = {
    **COMMOM_IO_TOOLTIPS,
    ...
    "input_image_gcs_uri": (
        "GCS URI of the input image in the format 'gs://BUCKET_NAME/SUBDIRECTORY.'."
    ),
    ...
    "last_frame": (
        "Image to use as the last frame of generated videos. Only supported for image "
        "to video use cases."
    ),
    "image_mime_type": "Mime type of the input image, e.g., 'image/png' or 'image/jpeg'.",
    "first_frame": (
        "Image to use as the first frame of generated videos. Only supported for image "
        "to video use cases."
    ),
}
...
DOCUMENTATION = {
    "ImageToVideoNode": create_documentation(
        "Image to Video 📹🖼️",
